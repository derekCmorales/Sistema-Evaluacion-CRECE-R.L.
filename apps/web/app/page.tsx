    ...
    <div className="min-h-screen bg-[#034381] text-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <p className="text-white/85 leading-relaxed mb-8">
          Monorepo greenfield: Next.js (web) + NestJS (api). Expediente digital,
          cálculos determinísticos y autorización configurable. La IA asiste en
          revisión; no decide ni asigna puntaje.
        </p>
