...
Términos de negocio (es-GT) ↔ identificadores técnicos (inglés).

| Negocio | Tipo / concepto |
|---------|-----------------|
| Persona / prospecto / asociado | `Person` |
| Folder naranja (KYC / IVE) | `IdentityFolder` — tras aprobación |
